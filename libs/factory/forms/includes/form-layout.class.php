<?php
	...
	if( !class_exists('Wbcr_FactoryForms401_FormLayout') ) {

		/**
		 * The base class for all form layouts.
		 */
		abstract class Wbcr_FactoryForms401_FormLayout extends Wbcr_FactoryForms401_Holder {
			...
			public function __construct($options, $form)
			{
				...
				$this->addCssClass('factory-forms-401-' . $this->type);
				$this->addCssClass('factory-forms-401-' . $this->name);
			}
