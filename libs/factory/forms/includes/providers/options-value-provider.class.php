<?php
	...
	if( !class_exists('Wbcr_FactoryForms401_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms401_OptionsValueProvider implements Wbcr_IFactoryForms401_ValueProvider {
