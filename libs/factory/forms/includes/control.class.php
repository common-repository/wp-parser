<?php
	...
	if( !class_exists('Wbcr_FactoryForms401_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms401_Control extends Wbcr_FactoryForms401_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms401_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @since 1.0.0
			 * @param IFactoryForms401_ValueProvider $provider
			 * @return void
			 */
