<?php
	...
	if( !class_exists('Wbcr_FactoryForms401_ColorAndOpacityControl') ) {
	}

	class Wbcr_FactoryForms401_ColorAndOpacityControl extends Wbcr_FactoryForms401_ComplexControl {
		...
		public function __construct($options, $form, $provider = null)
		{
			...
			$this->opacity = new Wbcr_FactoryForms401_IntegerControl($options['opacity'], $form, $provider);
