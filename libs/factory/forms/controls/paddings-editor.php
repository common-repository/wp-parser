<?php
	...
	if( !class_exists('Wbcr_FactoryForms401_PaddingsEditorControl') ) {

		class Wbcr_FactoryForms401_PaddingsEditorControl extends Wbcr_FactoryForms401_Control {
				...
				<div <?php $this->attrs() ?>
					...
					<div class="factory-slider-container">
						<label class="factory-title">
							<?php _e('Select a side and move the slider to set up:', 'wbcr_factory_forms_401') ?>
						</label>
