<?php
	 ...
	 *  // see FactoryForms401_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms401_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms401_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms401_DropdownAndColorsControl extends Wbcr_FactoryForms401_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms401_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms401_RadioColorsControl($options['colors'], $form, $provider);
