<?php
	...
	if( !class_exists('Wbcr_FactoryForms401_GradientControl') ) {
		class Wbcr_FactoryForms401_GradientControl extends Wbcr_FactoryForms401_Control {
			...
			public function html()
			{
				...
				<script>
					...
					factory.res.resVertical = '<?php _e( 'vertical', 'wbcr_factory_forms_401' ) ?>';
					factory.res.resHorizontal = '<?php _e( 'horizontal', 'wbcr_factory_forms_401' ) ?>';
				</script>
				<div <?php $this->attrs() ?>>
