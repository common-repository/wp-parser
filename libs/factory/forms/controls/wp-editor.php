<?php
	...
	if( !class_exists('Wbcr_FactoryForms401_WpEditorControl') ) {

		class Wbcr_FactoryForms401_WpEditorControl extends Wbcr_FactoryForms401_Control {
			...
			protected function beforeHtml()
			{
				...
				if( !isset($this->options['tinymce']['content_css']) ) {
					$this->options['tinymce']['content_css'] = FACTORY_FORMS_401_URL . '/assets/css/editor.css';
				}
			}
