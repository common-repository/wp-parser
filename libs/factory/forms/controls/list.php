<?php
	...
	if( !class_exists('Wbcr_FactoryForms401_ListControl') ) {

		class Wbcr_FactoryForms401_ListControl extends Wbcr_FactoryForms401_Control {
			...
			protected function checklistHtml()
			{
				...
				$emptyList = $this->getOption('empty', __('The list is empty.', 'wbcr_factory_forms_401'));
