<?php
	...
	if( !class_exists('Wbcr_FactoryForms401_DatepickerRangeControl') ) {

		class Wbcr_FactoryForms401_DatepickerRangeControl extends Wbcr_FactoryForms401_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->range_1 = new Wbcr_FactoryForms401_TextboxControl($options['range_1'], $form, $provider);
				$this->range_2 = new Wbcr_FactoryForms401_TextboxControl($options['range_2'], $form, $provider);
