<?php
	...
	if( !class_exists('Wbcr_FactoryForms401_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms401_TabHolder extends Wbcr_FactoryForms401_Holder {
			 ...
			 * @param FactoryForms401_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms401_HtmlAttributeBuilder();
