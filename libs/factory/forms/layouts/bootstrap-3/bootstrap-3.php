<?php
	...
	if( !class_exists('Wbcr_FactoryForms401_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms401_Bootstrap3FormLayout extends Wbcr_FactoryForms401_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms401_Control $control
			 */
