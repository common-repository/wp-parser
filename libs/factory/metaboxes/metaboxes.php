<?php
	...
	if( !class_exists('Wbcr_FactoryMetaboxes401') ) {

		add_action('add_meta_boxes', 'Wbcr_FactoryMetaboxes401::actionAddMetaboxes');
		add_action('admin_enqueue_scripts', 'Wbcr_FactoryMetaboxes401::actionAdminEnqueueScripts');
		add_action('save_post', 'Wbcr_FactoryMetaboxes401::actionSavePost');
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryMetaboxes401 {

			/**
			 * A variable to store metaboxes per type they defined for.
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryMetaboxes401_Metabox[]
			 */
			 ...
			 * @return Wbcr_FactoryMetaboxes401_Metabox
			 */
			public static function register($class_name_or_object, Wbcr_Factory401_Plugin $plugin)
			{
