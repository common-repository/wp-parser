<?php
	...
	if( !class_exists('Wbcr_FactoryMetaboxes401_PublishMetabox') ) {
		/**
		 * A metabox containing the standart Publish/Update button.
		 *
		 * @since 1.0.0
		 */
		class Wbcr_FactoryMetaboxes401_PublishMetabox extends Wbcr_FactoryMetaboxes401_Metabox {

			/**
			 * @param Wbcr_Factory401_Plugin $plugin
			 */
			public function __construct(Wbcr_Factory401_Plugin $plugin = null)
			{
